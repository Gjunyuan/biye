  ...
  <body>
    ...
    <div class="main">
        ...
        <div class="main_top_li">
          ...
          <div class="main_top_centar">
            <div class="main_top_centar_text">
              ...
              <input type="text" name="text" placeholder="搜索关键词" id="select1" @change="select1()">
            </div>
          </div>
          <div class="main_top_right">
            <img class="head" src="../image/vague_img2.php?x=2&url=head/<?php echo $message{'head'} ?>" alt="" />
      ...
      <div class="main_top_bg">
        <?php echo $message{'name'} //echo $title{'title1'} ?>
      </div>
        ...
        <div class="main_container">
          ...
          <div class="main_container_left">
            <div class="container_none" v-cloak v-show="NoneDynamic">
              这里什么都没有哦~
            </div>
              <!-- 动态方块 -->
            <div class="container_div" v-cloak v-for="(item,index) in dynamiclist" :key="index">
              <!-- 顶部头像部分 -->
              <div class="main_div_top">
                ...
                <div class="btn-group" style="float:right;margin-top:-15px;">
                	<button type="button" class="btn btn-default dropdown-toggle"
                		...
                		<span class="fa fa-angle-down" style="color: #666;font-size: 30px;"></span>
                	</button>
              ...
              <!-- 底部 -->
              <div class="container_div_bottom" @click="DivHref(item.id,'<?php echo $_GET['n']?>','<?php echo $_GET['p']?>')" >
    ...
    <script>
      ...
      var app =new Vue({
        ...
        methods:{
          ...
          DivHref(id,n,p,Y,I){
            window.location='container.php?id='+id+'&n='+n+'&p='+p+'&Y='+Y+'&I='+I
          }
        }
      });
    </script>
